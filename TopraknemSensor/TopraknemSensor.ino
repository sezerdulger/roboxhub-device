...
const char* ssid     = "EDSD";
const char* password = "erhan16sezer08";
const char* mqttServer = "192.168.1.39";
const char* httpServer = "192.168.1.39";
...
//ADC_MODE(ADC_VCC); // measure battery
...
String device_topraknem="sezer";
String token_topraknem="Basic dG9wcmFrbmVtOjEyMzQ1Njc4";

String device_name=device_topraknem;
String token=token_topraknem;
...
void sendSoilHumidity() {
  float soilHumidity1 = digitalRead(D0) / 10;

  Serial.println("soilHumidity ");
  Serial.println(soilHumidity1);

   float   soilHumidity2 = analogRead(A0) / 10;

  Serial.println("soilHumidity ");
  Serial.println(soilHumidity2);

   float   soilHumidity3 = analogRead(0) / 10;

  Serial.println("soilHumidity ");
  Serial.println(soilHumidity3);

    float  soilHumidity4 = analogRead(17) / 10;

  Serial.println("soilHumidity ");
  Serial.println(soilHumidity4);

   float  soilHumidity5 = analogRead(0.0) / 10;

  Serial.println("soilHumidity ");
  Serial.println(soilHumidity5);
uint16 batteryStatus = readvdd33();
   ...
   StaticJsonBuffer<300> jsonBuffer;
    ...
    root["data"]["soilHumidity1"]=soilHumidity1;
    root["data"]["soilHumidity2"]=soilHumidity2;
    root["data"]["soilHumidity3"]=soilHumidity3;
    root["data"]["soilHumidity4"]=soilHumidity4;
    root["data"]["soilHumidity5"]=soilHumidity5;
    root["data"]["soilHumidity6"]=soilHumidity5;
    root["data"]["soilHumidity7"]=soilHumidity5;
...
void post(String jsonString) {
  Serial.print("Trying to send...host is ");
    ...
    HTTPClient http;
    http.begin("http://192.168.1.39:8080/api/1.0/deviceData");
    //http.begin(exacturl);
